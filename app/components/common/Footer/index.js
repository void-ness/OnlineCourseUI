...
export default function Footer() {
    return (
        <div className="bg-[#252641] flex flex-col items-center py-10">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="flex">
                    <input id="user-email" type="email" placeholder="Your Email" className="mx-2 w-80 text-gray-400 bg-transparent border-2 border-gray-400 focus-within:outline-none rounded-full py-2 px-4"></input>
                    <button type="button" className="mx-2 text-white bg-[#49BBBD] px-6 py-2 rounded-full">Subscribe</button>
                </div>
            </div>
